...
import { Car, History, AlertCircle, User, LogOut } from 'lucide-react'

const navItems = [
  { href: '/portal', label: 'My Rentals', icon: Car },
    ...
    <div className="min-h-screen bg-brand-black flex">
      ...
      <aside className="w-64 bg-brand-surface border-r border-brand-border flex flex-col">
        <div className="p-6 border-b border-brand-border">
          ...
          <p className="text-xs text-brand-muted mt-1">Rental Portal</p>
        </div>
