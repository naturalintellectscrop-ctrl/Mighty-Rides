...
export default async function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-[#141312]">
      ...
      <section className="w-full px-6 sm:px-8 md:px-12 lg:px-20 xl:px-28 py-16 md:py-24 section-light">
        <div className="">
          <div className="max-w-3xl mx-auto reveal">
            <h2 className="text-2xl font-bold text-[#1A1815] mb-6">Our Story</h2>
      ...
      <section className="w-full px-6 sm:px-8 md:px-12 lg:px-20 xl:px-28 py-16 section-neutral">
        <div className="">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center reveal-group">
            ...
            <div>
              <p className="text-4xl font-bold text-[#8A6410]">Kampala</p>
      ...
      {/* Social Directory */}
      <section className="w-full px-6 sm:px-8 md:px-12 lg:px-20 xl:px-28 py-16 section-light">
        <div className="">
          <div className="text-center mb-8 reveal">
            <p className="text-sm md:text-base text-[#8A6410] uppercase tracking-widest mb-2 font-semibold">
              CONNECT
            </p>
            <h2 className="text-2xl font-bold text-[#1A1815]">Find Us Online</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white p-6 text-center rounded-xl border border-[#ECEAE3] shadow-[0_1px_2px_rgba(26,24,21,0.04)] hover:border-[#C8952A] hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(26,24,21,0.1)] transition-all"
            >
              <Youtube className="w-8 h-8 text-red-500 mx-auto mb-3" />
              <p className="text-sm font-bold text-[#1A1815]">YouTube</p>
              <p className="text-xs text-[#8A857C]">@MightyRides</p>
            </a>
            ...
            >
              ...
              <p className="text-sm font-bold text-[#1A1815]">Instagram</p>
              <p className="text-xs text-[#8A857C]">@themightyrides</p>
            </a>
            ...
            >
              ...
              <p className="text-sm font-bold text-[#1A1815]">Facebook</p>
              <p className="text-xs text-[#8A857C]">@themightyrides</p>
            </a>
            ...
            >
              ...
              <p className="text-sm font-bold text-[#1A1815]">WhatsApp</p>
              <p className="text-xs text-[#8A857C]">Chat with us</p>
            </a>
          </div>
        </div>
      </section>
